...
class BrandColors {
  static const Color colorDarkGrey = Color(0xFF303030);
  ...
  static const Color greyBlue = Color(0xFF181a20);
  static const Color greyGrey = Color(0xFF262a34);
  static const Color colorLightGrayFair = Color(0xFFe1e5e8);
  static const Color colorDimText = Color(0xFFadadad);
  static const Color colorGreen = Color(0xFF42f58d);
}
